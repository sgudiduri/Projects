...
def build_model(df,stockname,seqlen):
    ...
    #os.chdir('..')
    os.chdir('''StockModelScripts\\FinalModel\\Model\\NoSentiment\\''')          
...
os.chdir('''..''')
os.chdir('''SentimentModelScripts\\''')
df_completestock_pred.to_csv('Outputs/Visualizations/Data/StocksPrices_wSentiment_PricePred_WithoutSentiment.csv',index=False)
