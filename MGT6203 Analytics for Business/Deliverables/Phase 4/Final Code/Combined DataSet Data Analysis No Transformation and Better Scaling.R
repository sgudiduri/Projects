...
# Load testData*
physicalAndEnvironmentalDataOriginal <- physicalAndEnvironmentalDataOriginal[indSampleInd,]
...
physicalAndEnvironmentalDataOriginal <- physicalAndEnvironmentalDataOriginal[, factorsFromRegression]
